    ...
    <div >
      ...
      <div className=' flex flex-col sm:flex-row gap-4'>
        ...
        <div className=' flex-1 border border-gray-400 rounded-lg px-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* -------------Doc info : nsme dgree experience------------ */}
      ...
      <div className=' sm:ml-72 sm:pl-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointmet} className=' bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
